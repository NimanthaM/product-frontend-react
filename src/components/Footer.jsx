                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            />
                            <h3 className="text-2xl font-bold text-cyan-400">Ecommerce</h3>
                        </div>
                        <p className="text-gray-400 mb-4 max-w-md">
                            Your trusted destination for premium tech products and accessories.
                            We bring you quality products at competitive prices with exceptional customer service.
                        </p>
                ...
                <div className="border-t border-gray-800 pt-8 mt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p className="text-gray-400 text-sm">
                            © {currentYear} Aahaas Ecommerce. All rights reserved.
                        </p>
